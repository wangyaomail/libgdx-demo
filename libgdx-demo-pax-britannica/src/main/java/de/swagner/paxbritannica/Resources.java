...
public class Resources {
    ...
    public Sprite title = new Sprite(new Texture(Gdx.files.internal("assets/pb/"+"data/spritepack/title.png")));
    public Sprite credits = new Sprite(new Texture(Gdx.files.internal("assets/pb/"+"data/spritepack/credits.png")));

    public TextureAtlas atlas = new TextureAtlas(Gdx.files.internal("assets/pb/"+"data/spritepack/packhigh.pack"));
    // public AtlasRegion region = atlas.findRegion("imagename");
    // Sprite sprite = atlas.createSprite("otherimagename");

    public Music music = Gdx.audio.newMusic(Gdx.files.internal("assets/pb/"+"data/audio/music.mp3"));
    ...
    public void reInit() {
        ...
        if (prefs.getInteger("antiAliasConfig", 1) == 0) {
            atlas = new TextureAtlas(Gdx.files.internal("assets/pb/"+"data/spritepack/pack.pack"));
        } else {
            atlas = new TextureAtlas(Gdx.files.internal("assets/pb/"+"data/spritepack/packhigh.pack"));
        }
        ...
        try {
            ...
            music = Gdx.audio.newMusic(Gdx.files.internal("assets/pb/"+"data/audio/music.mp3"));
        } catch (Exception e) {
            music = Gdx.audio.newMusic(Gdx.files.internal("assets/pb/"+"data/audio/music.mp3"));
        }
        ...
        title = new Sprite(new Texture(Gdx.files.internal("assets/pb/"+"data/spritepack/title.png")));
        title.getTexture().setFilter(TextureFilter.Linear, TextureFilter.Linear);
        credits = new Sprite(new Texture(Gdx.files.internal("assets/pb/"+"data/spritepack/credits.png")));
