...
public class Art {
    ...
    public static void load() {
        bg = load("assets/metagun/"+"res/background.png", 320, 240);
        level = new Pixmap(Gdx.files.internal("assets/metagun/"+"res/levels.png"));
        titleScreen = load("assets/metagun/"+"res/titlescreen.png", 320, 740);
        guys = split("assets/metagun/"+"res/guys.png", 6, 6);
        player1 = split("assets/metagun/"+"res/player.png", 16, 32);
        player2 = split("assets/metagun/"+"res/player.png", 16, 32, true);
        walls = split("assets/metagun/"+"res/walls.png", 10, 10);
        gremlins = split("assets/metagun/"+"res/gremlins.png", 30, 30);
        buttons = split("assets/metagun/"+"res/buttons.png", 32, 32);
        shot = new TextureRegion(guys[0][0].getTexture(), 3, 27, 2, 2);
        winScreen1 = load("assets/metagun/"+"res/winscreen1.png", 320, 240);
        winScreen2 = load("assets/metagun/"+"res/winscreen2.png", 320, 240);
    }
