...
public class GameLoop extends InvadersScreen implements SimulationListener {
    ...
    public GameLoop(Invaders invaders) {
        ...
        explosion = Gdx.audio.newSound(Gdx.files.internal("assets/invaders/" + "data/explosion.wav"));
        shot = Gdx.audio.newSound(Gdx.files.internal("assets/invaders/" + "data/shot.wav"));
