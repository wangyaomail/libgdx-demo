...
public class Assets {
    ...
    public static void load() {
        ...
        String textureDir = "assets/var/"+"data/textures/" + (int) pixelDensity;
    ...
    private static float calculatePixelDensity() {
        FileHandle textureDir = Gdx.files.internal("assets/var/"+"data/textures");
        ...
        float rsDense =  CameraHelper.bestDensity(VIRTUAL_WIDTH, VIRTUAL_HEIGHT, densities.items);
        return rsDense;
    }
    ...
    private static void loadFonts() {
        String fontDir = "assets/var/"+"data/fonts/" + (int) pixelDensity + "/";
...
//        flyupFont = new BitmapFont(Gdx.files.internal(fontDir + FLYUP_FONT), false);
        scoreFont = new BitmapFont(Gdx.files.internal( "assets/font/bitmap_font.fnt"), false);
        textFont = new BitmapFont(Gdx.files.internal("assets/font/bitmap_font.fnt"), false);
        flyupFont = new BitmapFont(Gdx.files.internal("assets/font/bitmap_font.fnt"), false);
    ...
    private static Sound[] loadSounds(String dir) {
        FileHandle dh = Gdx.files.internal("assets/var/"+"data/sounds/" + dir);
    ...
    private static Sound loadSound(String filename) {
        return Gdx.audio.newSound(Gdx.files.internal("assets/var/"+"data/sounds/" + filename));
    }
